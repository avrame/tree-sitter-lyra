//! This crate provides The Lyra Programming Language Parser language support for the [tree-sitter] parsing library.
//!
...
//!     .expect("Error loading The Lyra Programming Language Parser parser");
